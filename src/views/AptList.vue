    ...
    <div class="items-block">
      <div class="item-row">
        <div class="item-col">
          ...
          <div class="info">
            <div class="text">
              <p>Location: 237c Mao Tse Toung Boulevard (245), Phnom Penh</p>
              <p>Type:room</p>
              <p>Price:$$$$$$</p>
            </div>
            <div class="info-btn">
              ...
              <button class="view-btn">
                <router-link to="/apartment/detail">View Details</router-link>
              </button>
            </div>
          </div>
        </div>
